...
#ifndef COMMON_TEST_I_TOOLS_H
#define COMMON_TEST_I_TOOLS_H
...
class Common_Test_I_Tools
{
 ...
 private:
  ...
  ACE_UNIMPLEMENTED_FUNC (Common_Test_I_Tools& operator= (const Common_Test_I_Tools&))
};

// include template definition
#include "common_test_i_tools.inl"
