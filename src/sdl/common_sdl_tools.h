...
#ifndef COMMON_SDL_TOOLS_H
#define COMMON_SDL_TOOLS_H
...
#include "common_sdl_common.h"

class Common_SDL_Tools
{
 public:
  static bool preInitializeVideo (const struct Common_SDL_VideoConfiguration&, // configuration
                                  const std::string&);                         // window/icon caption
#if defined (SDL_USE)
  static bool initializeVideo (const struct Common_SDL_VideoConfiguration&, // configuration
                               const std::string&,                          // window/icon caption
                               SDL_Surface*&,                               // return value: window surface
                               bool = true);                                // initialize window surface ?
  static SDL_Surface* initializeScreen (const struct Common_SDL_VideoConfiguration&); // configuration
  ...
  static bool initializeVideo (const struct Common_SDL_VideoConfiguration&, // configuration
                               ...
                               bool = true);                                // initialize window surface ?
  static bool initializeScreen (const struct Common_SDL_VideoConfiguration&, // configuration
                                const std::string&,                          // window/icon caption
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Common_SDL_Tools ())
  ACE_UNIMPLEMENTED_FUNC (~Common_SDL_Tools ())
  ACE_UNIMPLEMENTED_FUNC (Common_SDL_Tools (const Common_SDL_Tools&))
  ACE_UNIMPLEMENTED_FUNC (Common_SDL_Tools& operator= (const Common_SDL_Tools&))

  // predefined colors
  static bool videoIsPreInitialized;
};
