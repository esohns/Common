...
#   message (STATUS "PKG_GTK_4_LIBRARIES: ${PKG_GTK_4_LIBRARIES}")
   ...
   foreach (GTK4_LIBRARY ${PKG_GTK_4_LIBRARIES})
    set (GTK4_LIBRARIES "${VCPKG_LIB_DIR}/${GTK4_LIBRARY}.lib;${GTK4_LIBRARIES}")
   endforeach ()
...
#   message (STATUS "PKG_GTK_3_LIBRARIES: ${PKG_GTK_3_LIBRARIES}")
   ...
   foreach (GTK3_LIBRARY ${PKG_GTK_3_LIBRARIES})
    set (GTK3_LIBRARIES "${VCPKG_LIB_DIR}/${GTK3_LIBRARY}.lib;${GTK3_LIBRARIES}")
   endforeach ()
#   message (STATUS "GTK3_LIBRARIES: ${GTK3_LIBRARIES}")
#   set (GTK3_INCLUDE_DIRS ${VCPKG_INCLUDE_DIR})
