...
elseif (WIN32)
 ...
 set (wxWidgets_LIB_DIR "${wxWidgets_ROOT_DIR}/build/win32/lib/vc_dll")
...
#   message (STATUS "wxWidgets_ROOT_DIR: ${wxWidgets_ROOT_DIR}")
   set (wxWidgets_INCLUDE_DIRS "${wxWidgets_INCLUDE_DIRS};${wxWidgets_ROOT_DIR}/include/msvc")
  endif (WIN32)
...
if (Curses_FOUND)
 message (STATUS "curses found: ${Curses_ROOT_DIR}")
 set (CURSES_FOUND TRUE)
else ()
 if (UNIX)
  pkg_check_modules (PKG_CURSES ncurses panel)
  if (PKG_CURSES_FOUND)
   message (STATUS "curses found: ${PKG_CURSES_ROOT_DIR}")
   set (CURSES_FOUND TRUE)
