...
#  find_package (GTK)
  ...
  pkg_check_modules (PKG_GTK_4 gtk)
#  if (GTK_FOUND)
  if (PKG_GTK_4_FOUND)
   message (STATUS "found gtk")
   set (GTK4_FOUND ON)
   set (GTK4_INCLUDE_DIRS ${PKG_GTK_4_INCLUDE_DIRS})
#   message (STATUS "PKG_GTK_4_LIBRARIES: ${PKG_GTK_4_LIBRARIES}")
   set (GTK4_LIBRARIES "")
   foreach (GTK4_LIBRARY ${PKG_GTK_4_LIBRARIES})
    set (GTK4_LIBRARIES "${VCPKG_LIB_DIR}/lib/${GTK4_LIBRARY}.lib;${GTK4_LIBRARIES}")
   endforeach ()
#   message (STATUS "GTK4_LIBRARIES: ${GTK4_LIBRARIES}")
#   set (GTK4_INCLUDE_DIRS ${VCPKG_INCLUDE_DIR_BASE})
#   set (GTK4_LIBRARIES "gtk::gtk")
   set (GTK4_LIB_DIRS "${VCPKG_LIB_DIR}/bin")
  else ()
...
#  if (GTK_FOUND)
   if (PKG_GTK_3_FOUND)
    ...
    set (GTK3_FOUND ON)
    set (GTK3_INCLUDE_DIRS ${PKG_GTK_3_INCLUDE_DIRS})
#   message (STATUS "PKG_GTK_3_LIBRARIES: ${PKG_GTK_3_LIBRARIES}")
    set (GTK3_LIBRARIES "")
    foreach (GTK3_LIBRARY ${PKG_GTK_3_LIBRARIES})
     set (GTK3_LIBRARIES "${VCPKG_LIB_DIR}/lib/${GTK3_LIBRARY}.lib;${GTK3_LIBRARIES}")
    endforeach ()
#   message (STATUS "GTK3_LIBRARIES: ${GTK3_LIBRARIES}")
#   set (GTK3_INCLUDE_DIRS ${VCPKG_INCLUDE_DIR_BASE})
#   set (GTK3_LIBRARIES "gtk::gtk")
    set (GTK3_LIB_DIRS "${VCPKG_LIB_DIR}/bin")
   else ()
