...
# pkg_check_modules (PKG_WAYLAND REQUIRED libwayland-dev) # Ubuntu
   ...
   if (WAYLAND_LIBRARY)
    ...
    set (PKG_WAYLAND_FOUND TRUE)
   endif (WAYLAND_LIBRARY)
   set (PKG_WAYLAND_INCLUDE_DIRS "/usr/include")
   set (PKG_WAYLAND_LIBRARIES ${WAYLAND_LIBRARY})
   pkg_check_modules (PKG_XKBCOMMON xkbcommon)
  else ()
 ...
 if (PKG_WAYLAND_FOUND AND PKG_XKBCOMMON_FOUND)
  set (WAYLAND_FOUND TRUE)
  set (WAYLAND_INCLUDE_DIRS "${PKG_WAYLAND_INCLUDE_DIRS};${PKG_XKBCOMMON_INCLUDE_DIRS}")
  set (WAYLAND_LIBRARIES "${PKG_WAYLAND_LIBRARIES};${PKG_XKBCOMMON_LIBRARIES}")
 endif (PKG_WAYLAND_FOUND AND PKG_XKBCOMMON_FOUND)
endif (UNIX)
if (WAYLAND_FOUND)
