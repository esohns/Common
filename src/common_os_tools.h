...
class Common_OS_Tools
{
 public:
  ...
  inline static bool canCapability (unsigned long capability_in) { return Common_OS_Tools::hasCapability (capability_in, CAP_PERMITTED); }
  static bool hasCapability (unsigned long,               // capability
                             cap_flag_t = CAP_EFFECTIVE); // set
  inline static bool isCapable (unsigned long capability_in) { return Common_OS_Tools::hasCapability (capability_in, CAP_EFFECTIVE); }
