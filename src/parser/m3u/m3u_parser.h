...
#ifndef YY_YY_M3U_PARSER_H_INCLUDED
# define YY_YY_M3U_PARSER_H_INCLUDED
...
namespace yy {
  ...
  struct M3U_Playlist*          lval;
    ...
    parser (M3U_IParser_t* iparser_yyarg, M3U_IScanner_t* iscanner_yyarg);
    virtual ~parser ();
  ...
  private:
    ...
    // User arguments.
    M3U_IParser_t* iparser;
    M3U_IScanner_t* iscanner;
...
#endif // !YY_YY_M3U_PARSER_H_INCLUDED
