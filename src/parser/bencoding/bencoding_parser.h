...
#ifndef YY_YY_BENCODING_PARSER_H_INCLUDED
# define YY_YY_BENCODING_PARSER_H_INCLUDED
...
# endif
  ...
  Bencoding_Dictionary_t* dval;
    ...
    STRING = 259,                  // "string"
    LIST = 260,                    // "list"
    LIST_END = 261,                // "list_end"
    DICTIONARY = 262,              // "dictionary"
    DICTIONARY_END = 263           // "dictionary_end"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_STRING = 4,                            // "string"
        S_LIST = 5,                              // "list"
        S_LIST_END = 6,                          // "list_end"
        S_DICTIONARY = 7,                        // "dictionary"
        S_DICTIONARY_END = 8,                    // "dictionary_end"
        S_YYACCEPT = 9,                          // $accept
...
#endif // !YY_YY_BENCODING_PARSER_H_INCLUDED
