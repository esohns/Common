...
//#include "handle_ACEXML_Charoice.h"
...
Common_XML_Handler::Common_XML_Handler ()
 : inherited ()//,
////    myIncludeHeaderFile(),
////    myCurrentOutputFile(),
...
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::Common_XML_Handler"));

}

void
Common_XML_Handler::endDocument (void)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::endDocument"));
...
void
Common_XML_Handler::endElement (const ACEXML_Char* namespaceURI_in,
                                const ACEXML_Char* localName_in,
                                const ACEXML_Char* qName_in)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::endElement"));
...
void
Common_XML_Handler::startDocument (void)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::startDocument"));
...
void
Common_XML_Handler::startElement (const ACEXML_Char* namespaceURI_in,
                                  const ACEXML_Char* localName_in,
                                  const ACEXML_Char* qName_in,
                                  ACEXML_Attributes* attributes_in)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::startElement"));
...
//      ACEXML_Char* min_occurs_string_xml =
...
//      ACEXML_Char* max_occurs_string_xml =
...
//                       Handle_ACEXML_Charoice(myCurrentOutputFile,
//                                        myCurrentNestingLevel,
...
//    case XML_EXTENSION:
//    {
//      ACEXML_Char* base_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("base"));
...
////       {
////         const ACEXML_Char* Qname = attributes_in.getQName(i);
////         const ACEXML_Char* URI = attributes_in.getURI(i);
////         const ACEXML_Char* local = attributes_in.getLocalName(i);
////         const ACEXML_Char* type = attributes_in.getType(i);
////         const ACEXML_Char* value = attributes_in.getValue(i);
////         ACE_DEBUG((LM_DEBUG,
...
////       }
//
//      ACEXML_Char* id_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("id"));
...
//      ACEXML_Char* name_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("name"));
...
//
//      // extract value
//      ACEXML_Char* value_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("value"));
...
//      char* name = XMLString::transcode(attributes_in.getValue(name_string));
//      XMLString::release(&name_string);
//      ACEXML_Char* type_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("type"));
...
//        ACEXML_Char* use_string = XMLString::transcode(ACE_TEXT_ALWAYS_CHAR("use"));
...
//      ACEXML_Char* memberTypes_string =
...
void
Common_XML_Handler::error (ACEXML_SAXParseException& exception_in)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::error"));

  //char* message = XMLString::transcode(exception_in.getMessage());
  //ACE_ASSERT(message);

  //ACE_DEBUG((LM_ERROR,
  //           ACE_TEXT("Common_XML_Handler::error(file: \"%s\", line: %d, column: %d): \"%s\"\n"),
...
void
Common_XML_Handler::fatalError (ACEXML_SAXParseException& exception_in)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::fatalError"));

  //char* message = XMLString::transcode(exception_in.getMessage());
  //ACE_ASSERT(message);

  //ACE_DEBUG((LM_CRITICAL,
  //           ACE_TEXT("Common_XML_Handler::fatalError(file: \"%s\", line: %d, column: %d): \"%s\"\n"),
  //           ACE_TEXT(exception_in.getSystemId()),
  //           exception_in.getLineNumber(),
  //           exception_in.getColumnNumber(),
  //           ACE_TEXT(message)));
...
void
Common_XML_Handler::warning (ACEXML_SAXParseException& exception_in)
{
  COMMON_TRACE (ACE_TEXT ("Common_XML_Handler::warning"));

  //char* message = XMLString::transcode(exception_in.getMessage());
  //ACE_ASSERT(message);

  //ACE_DEBUG((LM_WARNING,
  //           ACE_TEXT("Common_XML_Handler::warning(file: \"%s\", line: %d, column: %d): \"%s\"\n"),
  //           ACE_TEXT(exception_in.getSystemId()),
  //           exception_in.getLineNumber(),
  //           exception_in.getColumnNumber(),
  //           ACE_TEXT(message)));
...
//Common_XML_Handler::XMLElementType
//Common_XML_Handler::stringToXMLElementType(const std::string& elementString_in) const
//{
//  COMMON_TRACE(ACE_TEXT("Common_XML_Handler::stringToXMLElementType"));
//
...
//
//void
//Common_XML_Handler::insertPreamble(std::ofstream& targetStream_inout)
//{
//  COMMON_TRACE(ACE_TEXT("Common_XML_Handler::insertPreamble"));
//
...
//
//void
//Common_XML_Handler::insertMultipleIncludeProtection(const bool& usePragmaOnce_in,
//                                             const std::string& filename_in,
//                                             std::ofstream& targetStream_inout)
//{
//  COMMON_TRACE(ACE_TEXT("Common_XML_Handler::insertMultipleIncludeProtection"));
//
//  if (usePragmaOnce_in)
...
//
//void
//Common_XML_Handler::insertPostscript(std::ofstream& targetStream_inout)
//{
//  COMMON_TRACE(ACE_TEXT("Common_XML_Handler::insertPostscript"));
//
...
//
//void
//Common_XML_Handler::insertIncludeHeaders(const XML2CppCode_Headers_t& headers_in,
//                                  const bool& includeStdVector_in,
//                                  std::ofstream& targetStream_inout)
//{
//  COMMON_TRACE(ACE_TEXT("Common_XML_Handler::insertIncludeHeaders"));
//
