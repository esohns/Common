...
elseif (WIN32)
 if (VCPKG_USE)
  ...
  if (LibXml2_FOUND)
   message (STATUS "found LibXml2")
   set (LIBXML2_FOUND TRUE)
   set (LIBXML2_INCLUDE_DIR "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/libxml2")
   set (LIBXML2_LIBRARIES "${VCPKG_LIB_DIR}/lib/libxml2.lib")
   set (LIBXML2_LIB_DIR "${VCPKG_LIB_DIR}/bin")
  endif (LibXml2_FOUND)
 endif (VCPKG_USE)
