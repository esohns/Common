...
# set (OpenGL_Components "OpenGL EGL GLX")
 ...
 if (NOT OPENGL_FOUND)
  ...
  find_path (GLU_INCLUDE_DIR
             NAMES ${GLU_HEADER_FILE}
             DOC "searching for ${GLU_HEADER_FILE}")
  if (NOT GLU_INCLUDE_DIR)
   message (WARNING "could not find ${GLU_LIB_FILE}, continuing")
  else ()
   message (STATUS "Found GLU header \"${GLU_INCLUDE_DIR}\"")
