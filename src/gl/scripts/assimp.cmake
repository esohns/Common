...
#   set (ASSIMP_LIB_WITH_SUFFIX "assimp-vc143-mt${LIB_FILE_SUFFIX}.lib")
 ...
 if (NOT ASSIMP_FOUND)
  set (ASSIMP_LIB_WITH_SUFFIX "assimp-vc${MSVC_TOOLSET_VERSION}-mt${LIB_FILE_SUFFIX}.lib")
#  set (ASSIMP_LIB_WITH_SUFFIX "assimp-vc143-mt${LIB_FILE_SUFFIX}.lib")
  find_library (ASSIMP_LIBRARY ${ASSIMP_LIB_WITH_SUFFIX}
                PATHS $ENV{LIB_ROOT}/assimp/cmake/lib
                PATH_SUFFIXES ${CMAKE_BUILD_TYPE}
                DOC "searching for ${ASSIMP_LIB_WITH_SUFFIX}"
                NO_DEFAULT_PATH)
  if (ASSIMP_LIBRARY)
   message (STATUS "found assimp")
   set (ASSIMP_FOUND TRUE)
   ...
   message (WARNING "could not find ${ASSIMP_LIB_WITH_SUFFIX}, continuing")
