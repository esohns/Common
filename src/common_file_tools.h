...
class Common_File_Tools
{
 public:
  ...
  inline static std::string directory (const std::string& path_in) { return ACE_TEXT_ALWAYS_CHAR (ACE::dirname (ACE_TEXT_CHAR_TO_TCHAR (path_in.c_str ()), ACE_DIRECTORY_SEPARATOR_CHAR)); }
  ...
  static bool isAbsolutePath (const std::string&); // (FQ) path
