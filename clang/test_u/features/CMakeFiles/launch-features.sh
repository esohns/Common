...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/Common/clang/test_u/features/features 
	else
		"/mnt/win_d/projects/Common/clang/test_u/features/features" -l -t 
	fi
else
	"/mnt/win_d/projects/Common/clang/test_u/features/features" -l -t 
fi
