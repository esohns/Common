...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/Common/clang/test_i/ffmpeg/ffmpeg 
	else
		"/mnt/win_d/projects/Common/clang/test_i/ffmpeg/ffmpeg" 12 /bin/bash 
	fi
else
	"/mnt/win_d/projects/Common/clang/test_i/ffmpeg/ffmpeg" 12 /bin/bash 
fi
