...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/Common/clang/test_i/ui/gtk/gtk_ui_3 
	else
		"/mnt/win_d/projects/Common/clang/test_i/ui/gtk/gtk_ui_3" -g./etc/gtk_ui.gtk2  
	fi
else
	"/mnt/win_d/projects/Common/clang/test_i/ui/gtk/gtk_ui_3" -g./etc/gtk_ui.gtk2  
fi
