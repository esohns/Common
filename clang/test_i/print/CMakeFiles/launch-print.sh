...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/Common/clang/test_i/print/print 
	else
		"/mnt/win_d/projects/Common/clang/test_i/print/print" -d -e -f test.txt -l -t 
	fi
else
	"/mnt/win_d/projects/Common/clang/test_i/print/print" -d -e -f test.txt -l -t 
fi
