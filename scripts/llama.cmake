...
if (UNIX)
 set (ggml_DIR $ENV{LIB_ROOT}/llama.cpp/build/gcc/lib64/cmake/ggml)
 find_package (ggml)
 if (ggml_FOUND)
  message (STATUS "found llama.cpp ggml")
 endif (ggml_FOUND)
 set (llama_DIR $ENV{LIB_ROOT}/llama.cpp/build/gcc/lib64/cmake/llama)
...
#  set (LLAMACPP_INCLUDE_DIRS "${llama_DIR}/../../include")
#  message (STATUS "LLAMA_INCLUDE_DIR: ${LLAMA_INCLUDE_DIR}")
 ...
 endif (llama_FOUND AND ggml_FOUND)
elseif (WIN32)
 if (VCPKG_USE)
