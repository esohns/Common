...
elseif (WIN32)
 ...
 set_property (CACHE TOOLCHAIN PROPERTY STRINGS "msvc" "llvm")
endif ()
...
elseif (WIN32)
 if (${TOOLCHAIN} MATCHES "msvc")
  ...
  endif (NOT MSVC_SUPPORT)
  set (MSVC_USE ON CACHE STRING "use MSVC")
