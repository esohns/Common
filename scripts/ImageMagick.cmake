...
elseif (WIN32)
 if (VCPKG_USE)
  ...
  if (PKG_GRAPHICSMAGICK_FOUND AND PKG_GRAPHICSMAGICKWAND_FOUND)
   ...
   set (GRAPHICSMAGICK_LIBRARY "${VCPKG_LIB_DIR}/GraphicsMagick.lib")
   set (GRAPHICSMAGICKWAND_LIBRARY "${VCPKG_LIB_DIR}/GraphicsMagickWand.lib")
#   set (ImageMagick_LIBRARIES "${PKG_GRAPHICSMAGICK_LIBRARIES};${PKG_GRAPHICSMAGICKWAND_LIBRARIES}")
   set (ImageMagick_LIBRARIES "${GRAPHICSMAGICK_LIBRARY};${GRAPHICSMAGICKWAND_LIBRARY}")
...
#   file (GLOB_RECURSE MAGICK_CONFIG FOLLOW_SYMLINKS /usr/bin/Magick++-config)
  ...
  set (MAGICK_CONFIG ${MAGICK_CONFIG} CACHE STRING "Path to [Graphics]Magick[Core]-config utility" FORCE)
