...
elseif (WIN32)
 ...
 if (${TARGET_OS_PLATFORM} MATCHES "Host System" OR "XP" OR "Vista" OR "7" OR "8" OR "10")
  set (SYSTEM_NAME Windows)
  if (${TARGET_OS_PLATFORM} MATCHES "Host System")
# *BUG*: CMAKE_HOST_SYSTEM_VERSION not set on Win32
  ...
  elseif (${TARGET_OS_PLATFORM} MATCHES "XP")
   set (SYSTEM_VERSION 5.2)
  elseif (${TARGET_OS_PLATFORM} MATCHES "Vista")
   set (SYSTEM_VERSION 6.0)
  elseif (${TARGET_OS_PLATFORM} MATCHES "7")
   set (SYSTEM_VERSION 6.1)
  elseif (${TARGET_OS_PLATFORM} MATCHES "8")
   set (SYSTEM_VERSION 6.2)
  elseif (${TARGET_OS_PLATFORM} MATCHES "10")
   set (SYSTEM_VERSION 10.0) # *NOTE*: most current of the installed SDK(s)
#  elseif (${TARGET_OS_PLATFORM} MATCHES "10")
#   set (SYSTEM_VERSION 10.0.10586.0)
  else ()
   message (FATAL_ERROR "target platform \(was: ${TARGET_OS_PLATFORM}\) not supported")
  endif ()
 elseif (${TARGET_OS_PLATFORM} MATCHES "CE")
  set (SYSTEM_NAME WindowsCE)
  set (SYSTEM_VERSION 8.0) # Windows Embedded Compact 2013
#  set (CMAKE_SYSTEM_PROCESSOR arm)
#  set (CMAKE_GENERATOR_TOOLSET CE800) # Can be omitted for 8.0
#  set (CMAKE_GENERATOR_PLATFORM SDK_AM335X_SK_WEC2013_V310)
 elseif (${TARGET_OS_PLATFORM} MATCHES "Phone")
  set (SYSTEM_NAME WindowsPhone)
  set (SYSTEM_VERSION 8.1)
 elseif (${TARGET_OS_PLATFORM} MATCHES "Android")
...
#  set (CMAKE_ANDROID_STL_TYPE gnustl_static)
 elseif (${TARGET_OS_PLATFORM} MATCHES "Store")
